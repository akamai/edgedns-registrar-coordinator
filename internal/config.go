...
func (cfg *Config) ParseFlags(app *kingpin.Application, args []string) (string, error) {
	...
	app.Flag("log-handler", "The handler used to log messages (default: text. options: text, json, cli, discard)").Default(DefaultConfig.LogHandler).EnumVar(&cfg.LogHandler, "text", "json", "cli", "discard")
